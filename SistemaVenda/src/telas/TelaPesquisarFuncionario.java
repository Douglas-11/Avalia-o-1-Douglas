...
public class TelaPesquisarFuncionario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Funcionario f = RepositorioDadosFuncionario.pesquisarFuncionarioPeloCodigo(cod);
        
        if (f != null){
            int opcao = JOptionPane.showConfirmDialog(this, f,"Deseja editar esse Funcionário?",JOptionPane.YES_NO_OPTION);
            if (opcao == JOptionPane.YES_OPTION){
                TelaCadastrarFuncionario tela = new TelaCadastrarFuncionario(f);
