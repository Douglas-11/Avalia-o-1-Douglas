...
public class TelaExcluirFuncionario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int excluirFuncionario = Integer.parseInt(deletar);

        Funcionario funcionario = RepositorioDadosFuncionario.pesquisarFuncionarioPeloCodigo(excluirFuncionario);

        if (funcionario != null){
            int opcao = JOptionPane.showConfirmDialog(this, funcionario,"Deseja excluir esse cliente?",JOptionPane.YES_NO_OPTION);
            if (opcao == JOptionPane.YES_OPTION){
                RepositorioDadosFuncionario.excluirFuncionario(funcionario);
                this.dispose();
